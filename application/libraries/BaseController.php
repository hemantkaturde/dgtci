...
class BaseController extends CI_Controller {
    ...
    function loadViews($viewName = "", $headerInfo = NULL, $pageInfo = NULL, $footerInfo = NULL){
        ...
        $this->load->view('includes/admin/header', $headerInfo);
        $this->load->view($viewName, $pageInfo);
        $this->load->view('includes/admin/footer', $footerInfo);
    }

	function webloadViews($viewName = "", $headerInfo = NULL, $pageInfo = NULL, $footerInfo = NULL){

        $this->load->view('includes/web/header', $headerInfo);
        $this->load->view($viewName, $pageInfo);
        $this->load->view('includes/web/footer', $footerInfo);
    }
