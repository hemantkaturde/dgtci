        ...
        <div class="container">
            ...
            <div class="row wed-foot-link">
                <div class="col-md-4 foot-tc-mar-t-o">
                    <h4>Get In Touch</h4>
                    <p>Address: Tal. Tala, Dist - Raigad - 402111</p>
                    <p>Phone: <a href="#!">02140269575 / 9273499354</a></p>
                    <p>Email: <a href="#!">dgtcollegetala1@yahoo.co.in</a></p>
                </div>
                <div class="col-md-4">
                    <h4>Courses</h4>
                    <ul>
        ...
        <div class="container">
            <div class="row">
                <div class="copy-right">
                    <p>Copyrights DGT College TALA © All rights reserved. Developed By Manoj Wadhwal 2022</p>
                </div>
            </div>
        </div>
    </section>
