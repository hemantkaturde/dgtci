                ...
                <div class="cor about-sp">
                    ...
                    <div class="pg-contact">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 new-con new-con1"> <img src="img/contact/1.png" alt="">
                            <h4>Address</h4>
                            <p>D. G. TATKARE ARTS & COMMERCE COLLEGE, TALA , Tal. Tala, Dist - Raigad - 402111.
                                <br>Landmark : Next To State Bank Of India</p>
                        </div>
                        <div class="col-md-4 col-sm-6 col-xs-12 new-con new-con3"> <img src="img/contact/2.png" alt="">
                            <h4>CONTACT INFO:</h4>
                            <p> <a href="tel://0099999999" class="contact-icon">Phone:  02140269575</a>
                                <br> <a href="tel://0099999999" class="contact-icon">Mobile: 9273499354</a>
                                <br> <a href="mailto:mytestmail@gmail.com" class="contact-icon">Email: dgtcollegetala1@yahoo.co.in</a> </p>
                        </div>
