        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel" style="height:550px">
            ...
            <div class="carousel-inner">
                <div class="item slider1 active">
                    <img src="<?php echo base_url() ?>assets/web/images/slider/banner1.png" alt="" style="height:550px">
                    <!-- <img src="<?php echo base_url() ?>assets/web/images/dgt/banner1.png" alt="" style="height:550px"> -->
                    <div class="carousel-caption slider-con">
                        <h2>Welcome to D G Tatkare College</h2>
                        <!--<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form</p>-->
                        <!--<a href="#" class="bann-btn-1">All Courses</a><a href="#" class="bann-btn-2">Read More</a>-->
                    </div>
                </div>
                <div class="item">
                    <img src="<?php echo base_url() ?>assets/web/images/slider/banner2.png" alt="" style="height:550px">
                    <div class="carousel-caption slider-con">
                ...
                <div class="item">
                    <img src="<?php echo base_url() ?>assets/web/images/slider/banner3.png" alt="" style="height:550px">
                    <div class="carousel-caption slider-con">
                        <h2>D G Tatkare College, Tala</h2>
                        <!--<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form</p>-->
                        <!--<a href="#" class="bann-btn-1">All Courses</a><a href="#" class="bann-btn-2">Read More</a>-->
                    </div>
                </div>
                <div class="item">
                    <img src="<?php echo base_url() ?>assets/web/images/slider/banner6.jpg" alt="" style="height:550px">
                    <div class="carousel-caption slider-con">
                        <h2>D G Tatkare College, Tala</h2>
                        <!--<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form</p>-->
                        <!--<a href="#" class="bann-btn-1">All Courses</a><a href="#" class="bann-btn-2">Read More</a>-->
